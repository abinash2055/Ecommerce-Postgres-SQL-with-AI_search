        ...
        <div className="max-w-4xl md:px-4 py-8">
          ...
          <div className="bg-gray-100 p-6 rounded-2xl shadow-md mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" name="name" value={editData.name} onChange={handleProfileChange} className="p-2 border rounded-md" placeholder="Your Name" />

              <input type="email" name="email" value={editData.email} onChange={handleProfileChange} className="p-2 border rounded-md" placeholder="Your Email" />

              <input type="file" name="avatar" onChange={handleAvatarChange} className="p-2 border rounded-md col-span-1 md:col-span-2" />
            </div>

            <button onClick={updateProfile} className="flex justify-center items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 mt-4 transition-all" disabled={loading}>

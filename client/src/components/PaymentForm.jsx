      ...
      <div>
        <form onSubmit={handleSubmit} className="glass-panel">
          ...
          <div className="flex items-center space-x-2 mb-6 p-4 bg-secondary/50 rounded-lg">
            ...
            <span className="text-sm text-muted-foreground">Your card information is encrypted and secure.</span>
          </div>

          <button type="submit" disabled={!stripe || isProcessing} className="flex justify-center items-center gap-2 w-full py-3 gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold">
            {isProcessing ? (
              <>

...
export const fetchAllProducts = createAsyncThunk("product/fetchAll", async ({ availability = "", price = "0 - 10000", category = "", ratings = "", search = "", page = 1 }, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(error.response.data.message || "Failed to fetched products....")
  }
})

// To Fetch Details of Single Product
export const fetchProductDetails = createAsyncThunk("product/singleProduct", async (id, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(error.response.data.message || "Failed to fetched product Details....")
  }
})

// To Post the Review on Product
...
// To Delete the Review on Product
...
// To Fetch the Product with AI Search (GEMINI API KEY)
export const fetchProductWithAI = createAsyncThunk("product/ai-search", async (userPrompt, thunkAPI) => {
  try {
    ...
    return thunkAPI.rejectWithValue(error.response.data.message || "Failed to fetched AI Filter products....")
  }
})
